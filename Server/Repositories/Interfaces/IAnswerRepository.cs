...
namespace Quanda.Server.Repositories.Interfaces
{
    ...
    public interface IAnswerRepository
    {
        ...
        /// <summary>
        ///     Metoda zwraca listę pod odpowiedzi.
        /// </summary>
        /// <param name="idAnswer">Id odpowiedzi głównej.</param>
        /// <param name="idUserLogged">Id użytkownika przeglądającego pytanie. Używane w celu wyznaczenia informacji o głosach oddanych na odpowiedzi.</param>
        /// <returns>List<AnswerResponseDTO></returns>
        Task<List<AnswerResponseDTO>> GetAnswerChildrenAsync(int idAnswer, int idUserLogged);
